...
class _AddContactState extends State<AddContact> {
  ...
  void _query() async {
    final allRows = await myDbHelper.queryAllRows();
    if (kDebugMode) {
      print('query all rows:');
    }
    for (var element in allRows) {
      allCategoryData.add(element["c_name"]);
    }
    setState(() {});
  }
  ...
  void _insert() async {
    ...
    Map<String, dynamic> row = {
      myDbHelper.columnName: _firstName.text,
      myDbHelper.columnLName: _lastName.text,
      myDbHelper.columnMobile: _mobile.text,
      myDbHelper.columnEmail: _email.text,
      myDbHelper.columnCategory: currentCategory,
      myDbHelper.columnProfile: base64image,
    };
    print('insert stRT');
    currentCategory = "";
